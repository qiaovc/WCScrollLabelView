#
#  Be sure to run `pod spec lint WCScrollLabelView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "qiao"
  # s.authors            = { "qiao" => "iosqiao@qq.com" }
  # s.social_media_url   = "http://twitter.com/qiao"
